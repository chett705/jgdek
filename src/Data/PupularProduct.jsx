...
function PupularProduct() {
    const {products,isloading} = useContext(ProductContex);
  return (
     <div className='product px-5 '>
        <h3 className=' mb-5 font-mono text-2xl'>Weekly Pupular Product</h3>
             ...
             <div class=" flex   flex-nowrap gap-3 ">
            {
                ...
                products.map((v,i)=>{
                    return(
                        ...
                        <div class="shrink-0 rounded-xl w-[49%]   px-3 py-3 mb-4  carousel-items  md:w-[32%] lg:w-[31.5%] 
